...
#
# Key modifications:
# - Filters data to only include plays with > 3 minutes (180 seconds) remaining
...
#
# All results will be saved in a directory named 'robustness_checks_3min'.
# ==============================================================================
...
if (!dir.exists("robustness_checks_3min")) {
  dir.create("robustness_checks_3min")
}

cat("--- Libraries Loaded and 'robustness_checks_3min' directory created. ---\n\n")
...
# ROBUSTNESS CHECK: Filter for plays with more than 180 seconds remaining
third_down_data <- third_down_data[seconds_remaining_in_half > 180]
cat("Third down data filtered for > 180 seconds remaining.\n")
...
# Save all results
write.csv(tval_matrix_3rd, "robustness_checks_3min/third_down_3min_t_values.csv")
write.csv(se_matrix_3rd, "robustness_checks_3min/third_down_3min_standard_errors.csv")
write.csv(coef_matrix_3rd, "robustness_checks_3min/third_down_3min_coefficients_marginal_effects.csv")
write.csv(pval_matrix_3rd, "robustness_checks_3min/third_down_3min_p_values.csv")
...
write.csv(joint_test_results_3rd, "robustness_checks_3min/third_down_3min_joint_significance.csv")
...
# ROBUSTNESS CHECK: Filter for plays with more than 180 seconds remaining
attempt_data <- attempt_data[seconds_remaining_in_half > 180]
cat("Fourth down data filtered for > 180 seconds remaining.\n")
...
# Save all results
write.csv(tval_matrix_4th, "robustness_checks_3min/fourth_down_3min_attempt_t_values.csv")
write.csv(se_matrix_4th, "robustness_checks_3min/fourth_down_3min_attempt_standard_errors.csv")
write.csv(coef_matrix_4th, "robustness_checks_3min/fourth_down_3min_attempt_coefficients_marginal_effects.csv")
write.csv(pval_matrix_4th, "robustness_checks_3min/fourth_down_3min_attempt_p_values.csv")
...
write.csv(joint_test_results_4th, "robustness_checks_3min/fourth_down_3min_joint_significance.csv")
cat("--- Fourth down joint significance tests saved ---\n\n")

# Summary of results
cat("\n=== ANALYSIS COMPLETE ===\n")
cat("The following files have been saved in 'robustness_checks_3min':\n")
cat("\nThird Down Analysis:\n")
